...
import { AgentConnection } from "./connection/agent-connection.js";
import {
    CommandRouter,
...
export class AgentApp {
    ...
    public async start(): Promise<void> {
        ...
        logger.info("VPN node agent is starting", {
            nodeId: config.nodeId,
        ...
        try {
            ...
            logger.info("VPN node agent started");
        } catch (error) {
            logger.error(
    ...
    public async stop(
        ...
        logger.info("VPN node agent stopped");
    }
}